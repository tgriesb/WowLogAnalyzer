...
public class SpellPeriodicDrain : ICombatEvent, ISourceDestCombatEvent, IDamageCombatEvent
{
    ...
    [LogField(9)] public long SpellId { get; set; }      // 41382
    ...
    [LogField(14)] public long CurrentHP { get; set; }      // 75
    ...
    [LogField(22)] public long MaxResource { get; set; }         // 19093
    [LogField(23)] public long ResourceCost { get; set; }         // 20000
