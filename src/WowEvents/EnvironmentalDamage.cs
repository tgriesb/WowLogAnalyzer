...
public class EnvironmentalDamage : ICombatEvent, ISourceDestCombatEvent, IDamageCombatEvent
{
    ...
    [LogField(11)] public int CurrentHP { get; set; }    // 78
    ...
    [LogField(18)] public int CurrentResource { get; set; }       // 2
    [LogField(19)] public int MaxResource { get; set; }       // 47
    [LogField(20)] public int ResourceCost { get; set; }       // 100
    ...
    [LogField(24)] public int MapId { get; set; }       // 475
    [LogField(25)] public double Facing { get; set; }       // 0.0166
    [LogField(26)] public int ItemLvl { get; set; }       // 507
    ...
    [LogField(30)] public int School { get; set; }      // 0
