...
public class SpellAuraRefresh : ICombatEvent, ISourceDestCombatEvent
{
    ...
    [LogField(3)] public int SourceFlags { get; set; }      // 0x80000511
    [LogField(4)] public int SourceRaidFlags { get; set; }      // 0x80000004
    ...
    [LogField(8)] public int DestRaidFlags { get; set; }     // 0x80000004
    [LogField(9)] public int SpellId { get; set; }    // 107966
