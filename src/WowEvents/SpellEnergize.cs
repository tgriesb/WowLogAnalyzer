...
public class SpellEnergize : ICombatEvent, ISourceDestCombatEvent
{
    ...
    [LogField(9)] public int SpellId { get; set; }          // 111528
    ...
    [LogField(22)] public int MaxResource { get; set; }             // 60000
    ...
    [LogField(27)] public int MapId { get; set; }              // 339
    [LogField(28)] public double Facing { get; set; }           // 5.9947
    [LogField(29)] public int ItemLvl { get; set; }             // 505
    [LogField(30)] public double Amount { get; set; }              // 1.0000
    [LogField(31)] public double OverEnergize { get; set; }              // 0.0000
    [LogField(32)] public int PowerType { get; set; }            // 9
    [LogField(33)] public int AlternatePowerType { get; set; }          // 5
}