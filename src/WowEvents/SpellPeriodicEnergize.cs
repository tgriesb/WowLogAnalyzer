...
public class SpellPeriodicEnergize : ICombatEvent, ISourceDestCombatEvent
{
    ...
    [LogField(9)] public long SpellId { get; set; }       // 82726
    ...
    [LogField(21)] public long CurrentResource { get; set; }          // 2
    [LogField(22)] public long MaxResource { get; set; }          // 37
