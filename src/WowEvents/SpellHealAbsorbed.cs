...
public class SpellHealAbsorbed : ICombatEvent, ISourceDestCombatEvent, IAbsorbCombatEvent
{
    ...
    [LogField(3)] public int SourceFlags { get; set; }         // 0xa48
    ...
    [LogField(7)] public int DestFlags { get; set; }         // 0x514
    [LogField(8)] public int DestRaidFlags { get; set; }        // 0x80000000
    [LogField(9)] public int SpellId { get; set; }       // 123184
    ...
    [LogField(14)] public int HealerFlags { get; set; }       // 0x514
    [LogField(15)] public int HealerRaidFlags { get; set; }          // 0x80000000
    [LogField(16)] public int HealSpellId { get; set; }       // 52042
    [LogField(17)] public string HealSpellName { get; set; } = "";      // "Healing Stream Totem"
    [LogField(18)] public  int HealSpellSchool { get; set; }       // 0x8
    [LogField(19)] public double Amount { get; set; }         // 39146
    [LogField(20)] public int ORiginalHealAmount { get; set; }        // 39146
}