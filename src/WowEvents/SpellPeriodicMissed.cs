...
public class SpellPeriodicMissed : ICombatEvent, ISourceDestCombatEvent
{
    ...
    [LogField(3)] public long SourceFlags { get; set; }          // 0x40512                                             // "0x10a48"
    ...
    [LogField(7)] public long DestFlags { get; set; }          // 0x40512                                               // "0x8"
    [LogField(8)] public long DestRaidFlags { get; set; }         // 0x80000000                                         // "IMMUNE"
    [LogField(9)] public long SpellId { get; set; }        // 124255                                                    // "nil"
