...
public class SpellDispelFailed : ICombatEvent, ISourceDestCombatEvent
{
    public CombatSubEventType EventType => CombatSubEventType.SPELL_DISPEL_FAILED;

    // TODO: Couldnt find an example, copy SpellDispell for now
