...
public class DamageSplit : ICombatEvent, ISourceDestCombatEvent, IDamageCombatEvent
{
    ...
    [LogField(3)] public long SourceFlags { get; set; }    // 0x40512
    ...
    [LogField(9)] public long SpellId { get; set; }  // 6940
    [LogField(10)] public string SpellName { get; set; } = "";  // "Hand of Sacrifice"
    [LogField(11)] public long SpellSchool { get; set; }     // 0x2
    ...
    [LogField(22)] public long MaxResource { get; set; }     // 55800
    ...
    [LogField(29)] public long ItemLvl { get; set; }     // 514
