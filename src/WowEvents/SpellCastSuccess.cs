...
public class SpellCastSuccess : ICombatEvent, ISourceDestCombatEvent
{
    ...
    [LogField(9)] public long SpellId { get; set; }     // 73680
    ...
    [LogField(22)] public long MaxResource { get; set; }        // 300000
    [LogField(23)] public long ResourceCost { get; set; }        // 300000
    [LogField(24)] public long ResourceCostUnknownFlag { get; set; }        // 4920
    [LogField(25)] public float CordinateX { get; set; }        // -2204.73
    [LogField(26)] public float CordinateY { get; set; }        // 475.50
    [LogField(27)] public long MapId { get; set; }        // 475
    [LogField(28)] public double Facing { get; set; }        // 2.0504
    [LogField(29)] public long ItemLvl { get; set; }        // 508   
}