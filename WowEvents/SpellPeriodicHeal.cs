...
public class SpellPeriodicHeal : ICombatEvent, ISourceDestCombatEvent, IHealCombatEvent
{
    public CombatSubEventType EventType => CombatSubEventType.SPELL_PERIODIC_HEAL;
    ...
    [LogField(9)] public int SpellId { get; set; }           // 51945
    ...
    [LogField(22)] public int MaxResource { get; set; }              // 90
    ...
    [LogField(29)] public int ItemLvl { get; set; }              // 510
